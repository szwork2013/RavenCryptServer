...
exports.MasterJobs = function MasterJobs(config, model, logger, cron) {
    ...
    this.weekly = new CronJob('00 30 11 * * 1-5', function () {
    ...
    //        //runs once a day
    //
    //        var keyMaxAge = new Date() - config.session.KeyRenewInterval * 24 * 60 * 60 * 1000;
    //        /* ms */
    //
    ...
    this.deleteOldEntrys = new CronJob('0 0 * * *', function () {
            //runs once a day
