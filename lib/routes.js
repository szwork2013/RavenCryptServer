...
routes.userKey = {};
routes.userKey.insert = route("userKey/userKeyInsert.js");
...
app.post('/user/:user/key/:id', reqHandler({json: true, auth: true, checkSession: true, next: reqValidator(reqValidations.userKeyInsert)}), routes.userKey.insert);
