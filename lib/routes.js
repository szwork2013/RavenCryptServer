...
app.post('/user/:user/profile', reqHandler({json: true, auth: true, checkSession: true, next: reqValidator(reqValidations.userProfileUpdate())}), routes.user.profileUpdate);
app.get('/user/:user/options', reqHandler({next: reqValidator(reqValidations.userOptionsGet())}), routes.user.profileGet);
app.post('/user/:user/options', reqHandler({json: true, auth: true, checkSession: true, next: reqValidator(reqValidations.userOptionsUpdate())}), routes.user.profileUpdate);
...
app.post('/user/:user/encryption/:id', reqHandler({json: true, auth: true, checkSession: true, next: reqValidator(reqValidations.userEncryptionUpdate())}), routes.user.encryptionUpsert);
