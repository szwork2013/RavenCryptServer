    ...
    if(tooBusy()){
        ...
        if(config.isTestEnvironment()) {
            ...
            if (socket.handshake.query.tinychat == "true" &&
                socket.handshake.query.chattiny == "true") {
        ...
        if (socket.handshake.query.sessionKeyID !== undefined &&
            socket.handshake.query.encrypted !== undefined) {
            var sessionObj = {
                sessionKeyID: parseInt(socket.handshake.query.sessionKeyID),
                encrypted: socket.handshake.query.encrypted
            };
