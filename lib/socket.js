...
module.exports = function (config, io, constants, sequelize, Sequelize, logger, cluster, tooBusy, model, routes, errors) {
    /**
            ...
            if (socket.handshake.query.account !== undefined && socket.handshake.query.authentication !== undefined) {
                ...
                model.User
                    ...
                    .error(function (err) {
                        ...
                        next(new errors.SystemError());
                    })
                    .then(function (user) {
                        if (!user) {
                            logger.rcLog(req, logger.rcLogType.debug, constants.userNotFound);
                            next(new Error(constants.systemException));
    ...
    require("./io/ioTinyChat.js")(io, constants, sequelize, Sequelize, logger, cluster);
