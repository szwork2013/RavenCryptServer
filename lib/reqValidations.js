...
baseCheck.next = function(){};
baseCheck.check = function(){};

function isType(obj, name, type, cb) {
    this.prototype = baseCheck;
    this.check = function(){
...
function checkQueryDate(req, param, cb){
    this.prototype = baseCheck;
    this.check = function(){
        if (req.query[param]) {
...
function checkParamsUser(req, param, cb){
    this.prototype = baseCheck;
    this.check = function() {
...
function checkParamsServer(req, param, cb){
    this.prototype = baseCheck;
    this.check = function() {
        var value = req.params[param];
...
module.exports.conMsgGet = function (req, params) {
    checkParamsUser(req, "user");
    checkParamsUUIDV4(req, "conID");
    checkParamsUUIDV4(req, "id");
};

module.exports.userMsgGetDelete = function (req) {
    checkParamsUser(req, "user");
    checkParamsUUIDV4(req, "id");
};

module.exports.conMsgList = function (req) {
    checkParamsUser(req, "user");
    checkParamsUUIDV4(req, "conID");
    checkParamsUUIDV4(req, "id");
...
module.exports.userMsgList = function (req) {
    checkParamsUser(req, "user");
    checkQueryDate(req, "since");
};

module.exports.userStorageList = function (req) {
    checkParamsUser(req, "user");
    checkParamsUUIDV4(req, "id");
    checkQueryDate(req, "since");
};

module.exports.blogGetDelete = function (req) {
    checkParamsUser(req, "user");
    checkParamsUUIDV4(req, "id");
};

module.exports.uploadList = function (req) {
    checkParamsUser(req, "user");
};

module.exports.uploadGet = function(req){
    checkParamsUser(req, "user");
    checkParamsUUIDV4(req, "id");
};
...
module.exports.blogPost = function (req) {
    checkParamsUser(req, "user");
    checkParamsUUIDV4(req, "id");
...
module.exports.blogResponsePost = function (req) {
    checkParamsUser(req, "user");
...
module.exports.userStorageUpsert = function (req) {
    checkParamsUser(req, "user");
    checkParamsUUIDV4(req, "id");
    isType(req.body, "text", "string");
    isType(req.body, "keyID", "string");
...
module.exports.userRegister = function (req) {
    checkParamsUser(req,  "user");
...
module.exports.userRegisterConfirm = function (req) {
    checkParamsUser(req, "user");
    helper.hasExactProperties(
...
module.exports.userProfileUpdate = function (req) {
    checkParamsUser(req, "user");
    isType(req.body, "profile", "string");
...
module.exports.userEncryptionGet = function (req) {
    checkParamsUser(req, "user");
};

module.exports.userEncryptionUpdate = function (req) {
    checkParamsUser(req, "user");
    isType(req.body, "encryptionTest", "string");
    isType(req.body, "encryptionVersion", "number");
    isType(req.body, "encryptionID", "string");
...
module.exports.userProfileGet = function (req) {
    checkParamsUser(req, "user");
};

module.exports.userExists = function (req) {
    checkParamsUser(req, "user");
};

module.exports.blogResponseList = function (req) {
    checkParamsUser(req, "user");
    checkParamsUUIDV4(req, "blogID");
    checkQueryDate(req, "since");
...
module.exports.blogResponseGetDelete = function (req) {
    checkParamsUser(req, "user");
    checkParamsUUIDV4(req, "blogID");
    checkParamsUser(req, "name");
    checkParamsServer(req, "server");
...
module.exports.blogResponseReview = function (req) {
    checkParamsUser(req, "user");
    checkParamsUUIDV4(req, "blogID");
    checkParamsUser(req, "name");
    checkParamsServer(req, "server");
...
module.exports.conversationManifestGetDelete = function(req){
    checkParamsUser(req, "user");
    checkParamsUUIDV4(req, "id");
};

module.exports.conversationManifestUpsert = function(req){
    checkParamsUser(req, "user");
    checkParamsUUIDV4(req, "id");
    isType(req.body, "text", "string");
...
module.exports.blogRelationList = function (req) {
    checkParamsUser(req, "user");
    checkQueryDate(req, "since");
};

module.exports.blogRelationGetDelete = function (req) {
    checkParamsUser(req, "user");
    checkParamsUser(req, "name");
    checkParamsServer(req, "server");
};

module.exports.blogRelationUpsert = function (req) {
    checkParamsUser(req, "user");
    checkParamsUser(req, "name");
    checkParamsServer(req, "server");
    isType(req.body, "text", "string");
...
module.exports.userStorageGetDelete = function (req) {
    checkParamsUser(req, "user");
    checkParamsUUIDV4(req, "id");
};

module.exports.conMsgReceive = function (req) {
    checkParamsUser(req, "user");
    checkParamsUUIDV4(req, "conID");
    checkParamsUUIDV4(req, "id");
    isType(req.body, "text", "string");
...
module.exports.userMsgReceive = function (req) {
    checkParamsUser(req, "user");
    checkParamsUUIDV4(req, "id");
    isType(req.body, "text", "string");
    isType(req.body, "keyID", "string");
...
module.exports.userKeyGet = function (req) {
    checkParamsUser(req, "user");
    checkParamsKeyID(req, "id");
};

module.exports.userKeyList = function (req) {
    checkParamsUser(req, "user");
};

module.exports.userKeyUpsert = function (req) {
    checkParamsUser(req, "user");
    checkParamsKeyID(req, "id");
...
module.exports.userKeyMakeLogin = function (req) {
    checkParamsUser(req, "user");
    checkParamsKeyID(req, "id");
};


module.exports.userKeyLogin = function (req) {
    checkParamsUser(req, "user");
    checkParamsKeyID(req, "id");
