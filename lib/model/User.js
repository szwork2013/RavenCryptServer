...
module.exports =
    sequelize.define('User', {
        ...
        userEncryptionTest: {
            comment: "Test String for the user Encryption, so the Client can successfully determine if decryption works",
        ...
        userEncryptionInfo: {
            comment: "Information the User Left to remember his encryption info",
            type: DataTypes.STRING,
            allowNull: false,
            validate: {
                is: config.validations.pubKeyID.regExp
