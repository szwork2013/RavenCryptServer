...
module.exports =
    sequelize.define('UserRegister', {
        ...
        encryptionMats: {
            comment: "Encrypted JSON Encryption Key and IV for to decrypt the Private Keys",
            type: DataTypes.STRING,
            allowNull: true,
            validate: {
        ...
        encryptionTest: {
            comment: "Test String for the user Encryption, so the Client can successfully determine if the decryption worked and he Entered the Right Password",
            type: DataTypes.STRING,
            allowNull: true,
            validate: {
                is: config.validations.pubKeyID.regExp
